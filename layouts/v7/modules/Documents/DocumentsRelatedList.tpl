                    ...
                    <td style="width:100px">&nbsp;&nbsp;&nbsp;
                        <span class="actionImages">
                            ...
                            {if $DOCUMENT_RECORD_MODEL->get('filename') && $DOCUMENT_RECORD_MODEL->get('filestatus')}
                                <a name="viewfile" class="custom_img_view" href="javascript:void(0)" data-filelocationtype="{$DOCUMENT_RECORD_MODEL->get('filelocationtype')}" data-url="{$DOCUMENT_RECORD_MODEL->getDownloadFileURL()}" data-filename="{$DOCUMENT_RECORD_MODEL->get('filename')}"><i title="{vtranslate('LBL_VIEW_FILE', $RELATED_MODULE_NAME)}" class="fa fa-picture-o alignMiddle"></i></a>&nbsp;&nbsp;
                            {/if}
