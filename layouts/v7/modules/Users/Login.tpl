...
{strip}
	<style>
		body {
			...
			background-image: url(layouts/v7/resources/Images/login_Banner.jpg);
			background-position: center;
			background-size: contain;
			width: 100%;
			/*height: 96%;*/
			background-repeat: no-repeat;
			border-top:5px solid #ca281b;
		}
		hr {
			margin-top: 15px;
		...
		.title { padding:0 20px; text-align:center;color:#f93a00;margin: 0 auto;}
		.ripples {
			position: absolute;
			top: 0;
			left: 0;
	...
	<span class="app-nav"></span>
		...
		{* <--<div class="col-lg-5">--> *}
			<div class="loginDiv">
				<img class="img-responsive user-logo" src="layouts/v7/resources/Images/GoldenDivine.jpg">
				<h4 class="title">Welcome, please sign in</h4>
				<div>
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
                        ...
                        <div class="group">
							<a class="forgotPasswordLink" style="color: #007bdb;">Forgot your password?</a>
						</div>
						<div class="group">
