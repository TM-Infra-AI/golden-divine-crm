         ...
         {if $BLOCK_FIELDS|@count gt 0}
             <div class='fieldBlockContainer' data-block="{$BLOCK_LABEL}">
                     ...
                     {if $MODULE eq 'SalesOrder' && $BLOCK_LABEL eq 'LBL_SO_INFORMATION'}
                        <div class="text-right"><a id="createnewproduct" class="btn btn-default createnewproduct" data-name="Products" data-url="index.php?module=Products&view=QuickCreateAjax" href="javascript:void(0)"><i class="fa fa-plus"></i><span class="quick-create-module"> &nbsp; ADD PRODUCT</span></a></div>
                    {/if}
                 <hr>
