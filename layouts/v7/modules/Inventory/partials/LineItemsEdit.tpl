	...
	{if $BLOCK_FIELDS|@count gt 0}
			...
			<div class="row">
				<div class="col-lg-5 col-md-5 col-sm-5">
					<div class="row">
						...
						<div class="col-lg-8 col-md-8 col-sm-8" style="top: 3px;display: none;">
				...
				<div class="col-lg-3 col-md-3 col-sm-3" style="top: 3px;display: none;">
					<center>
						<i class="fa fa-info-circle"></i>&nbsp;
				...
				<div class="col-lg-4 col-md-4 col-sm-4" style="top: 3px;" id="tax-mode">
		...
		<div class="fieldBlockContainer">
			<table class="table table-bordered blockContainer lineItemTable" id="lineItemResult">
				...
				<tr valign="top" class="adjustment">
					<td width="83%" >
