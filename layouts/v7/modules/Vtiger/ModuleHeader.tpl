				...
				<div id="appnav" class="navbar-right">
					<ul class="nav navbar-nav">
					    {if $MODULE_NAME eq 'SalesOrder'}
                            ...
                            <li><button class="btn btn-default module-buttons" type="button" onclick="window.location.href = &quot;index.php?module=Products&amp;view=Edit&amp;app=INVENTORY&quot;"><div class="fa fa-plus" aria-hidden="true"></div> &nbsp;&nbsp;Add Product</button></li>
        			    {/if}
					    {if $MODULE_NAME neq 'SalesOrder'}
					...
					{else}
					{if $USER_MODEL->get('roleid') eq 'H4' || $USER_MODEL->get('roleid') eq 'H2' || $USER_MODEL->get('roleid') eq 'H5'}
					<ul class="nav navbar-nav">
						{foreach item=BASIC_ACTION from=$MODULE_BASIC_ACTIONS}
							{if $BASIC_ACTION->getLabel() == 'LBL_IMPORT'}
								<li>
