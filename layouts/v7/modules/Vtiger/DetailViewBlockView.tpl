...
<!-- ($MODULE_NAME eq 'Accounts' && $ROLE eq 'H4'  && $FIELD_MODEL->get('label') eq 'Account Name') -->

											{if ($MODULE_NAME eq 'SalesOrder' && $ROLE eq 'H4' && $FIELD_MODEL->get('label') eq 'Account Name' || $FIELD_MODEL->get('label') eq 'Subject') || ($MODULE_NAME eq 'Accounts' && $ROLE eq 'H4'  && $FIELD_MODEL->get('label') eq 'Account Name')}
											
											<span class="action pull-right" style="display: none;"><a href="#" onclick="return false;" class="editAction fa fa-pencil"></a></span>

											{else}
											<span class="action pull-right" ><a href="#" onclick="return false;" class="editAction fa fa-pencil"></a>
											</span>
											{/if}
