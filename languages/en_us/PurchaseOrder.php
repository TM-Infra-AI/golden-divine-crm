...
$languageStrings = array(
    'PurchaseOrder' => 'Purchase Estimates',
	//DetailView Actions
	'SINGLE_PurchaseOrder' => 'Purchase Estimate',
	'LBL_EXPORT_TO_PDF' => 'Export to PDF',
    'LBL_SEND_MAIL_PDF' => 'Send Email with PDF',

	//Basic strings
	'LBL_ADD_RECORD' => 'Add Purchase Estimate',
	'LBL_RECORDS_LIST' => 'Purchase Estimate List',
	'LBL_COPY_SHIPPING_ADDRESS' => 'Copy Shipping Address',
	'LBL_COPY_BILLING_ADDRESS' => 'Copy Billing Address',

	// Blocks
	'LBL_PO_INFORMATION' => 'Purchase Estimate Details',

	//Field Labels
	'PurchaseOrder No' => 'Purchase Estimate Number',
