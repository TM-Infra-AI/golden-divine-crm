<?php /* Smarty version Smarty-3.1.7, created on 2021-10-28 18:48:04
         compiled from "/home/goldendivinecrmm/public_html/includes/runtime/../../layouts/v7/modules/Inventory/partials/EditViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:62559979761407549c6a468-28046007%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c19e59d2ea530b40748c64623b064afb9b96790b' => 
    array (
      0 => '/home/goldendivinecrmm/public_html/includes/runtime/../../layouts/v7/modules/Inventory/partials/EditViewContents.tpl',
      1 => 1635446806,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '62559979761407549c6a468-28046007',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_61407549d9f7c',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_61407549d9f7c')) {function content_61407549d9f7c($_smarty_tpl) {?>
...
</h4><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='SalesOrder'&&$_smarty_tpl->tpl_vars['BLOCK_LABEL']->value=='LBL_SO_INFORMATION'){?><div class="text-right"><a id="createnewproduct" class="btn btn-default createnewproduct" data-name="Products" data-url="index.php?module=Products&view=QuickCreateAjax" href="javascript:void(0)"><i class="fa fa-plus"></i><span class="quick-create-module"> &nbsp; ADD PRODUCT</span></a></div><?php }?><hr><table class="table table-borderless <?php if ($_smarty_tpl->tpl_vars['BLOCK_LABEL']->value=='LBL_ADDRESS_INFORMATION'){?> addressBlock<?php }?>"><?php if (($_smarty_tpl->tpl_vars['BLOCK_LABEL']->value=='LBL_ADDRESS_INFORMATION')&&($_smarty_tpl->tpl_vars['MODULE']->value!='PurchaseOrder')){?><tr><td class="fieldLabel " name="copyHeader1"><label  name="togglingHeader"><?php echo vtranslate('LBL_BILLING_ADDRESS_FROM',$_smarty_tpl->tpl_vars['MODULE']->value);?>
