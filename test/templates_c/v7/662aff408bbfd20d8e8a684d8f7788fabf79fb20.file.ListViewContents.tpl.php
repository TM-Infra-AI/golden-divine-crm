<?php /* Smarty version Smarty-3.1.7, created on 2021-06-26 06:22:05
         compiled from "/home/marketingmindz/goldendivinecrm.marketingmindz.com/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:192914471060cb4d9d18c803-45840352%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '662aff408bbfd20d8e8a684d8f7788fabf79fb20' => 
    array (
      0 => '/home/marketingmindz/goldendivinecrm.marketingmindz.com/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl',
      1 => 1624688475,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '192914471060cb4d9d18c803-45840352',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_60cb4d9d28f12',
  'variables' => 
  array (
    'MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_60cb4d9d28f12')) {function content_60cb4d9d28f12($_smarty_tpl) {?>
...
<div class="col-sm-12 col-xs-12 ">
	<?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='EmailTemplates'&&$_smarty_tpl->tpl_vars['SEARCH_MODE_RESULTS']->value!=true){?>
		...
		<?php if ($_smarty_tpl->tpl_vars['USER_MODEL']->value->isAdminUser()==1){?>
...
">
				...
				<!-- <?php echo print_r($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES']->value);?>
 -->
...
?>
					<?php $_smarty_tpl->tpl_vars["modifyby"] = new Smarty_variable($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->rawData['modifiedby'], null, 0);?>
					<!-- <pre> -->
					<!-- <?php echo print_r($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->rawData['modifiedby']);?>
 -->
						...
						<?php }?>
						<!-- <?php if (($_smarty_tpl->tpl_vars['modifyby']->value)=='H4'){?><tr><td><?php echo print_r($_smarty_tpl->tpl_vars['modifyby']->value);?>
</td></tr><?php }?> -->
						<?php if (($_smarty_tpl->tpl_vars['modifyby']->value)=='H4'&&$_smarty_tpl->tpl_vars['MODULE']->value=='SalesOrder'){?>
						<tr class="listViewEntries" style="background-color: #5bc0de;" data-id='<?php echo $_smarty_tpl->tpl_vars['DATA_ID']->value;?>
...
"><?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>
									...
									<?php }else{ ?>
										<?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='72'){?>
											<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('currency_symbol_placement');?>
<?php $_tmp6=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['CURRENCY_SYMBOL_PLACEMENT'] = new Smarty_variable($_tmp6, null, 0);?>
											<?php if ($_smarty_tpl->tpl_vars['CURRENCY_SYMBOL_PLACEMENT']->value=='1.0$'){?>
												<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value;?>
<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('currencySymbol');?>
...
<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value;?>
										...
										<?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='picklist'){?>
											<?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('activitytype')=='Task'){?>
												<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getId();?>
<?php $_tmp7=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['PICKLIST_FIELD_ID'] = new Smarty_variable($_tmp7, null, 0);?>
											<?php }else{ ?>
												<?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()=='taskstatus'){?>
													<?php $_smarty_tpl->tpl_vars["EVENT_STATUS_FIELD_MODEL"] = new Smarty_variable(Vtiger_Field_Model::getInstance('eventstatus',Vtiger_Module_Model::getInstance('Events')), null, 0);?>
													<?php if ($_smarty_tpl->tpl_vars['EVENT_STATUS_FIELD_MODEL']->value){?>
														<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['EVENT_STATUS_FIELD_MODEL']->value->getId();?>
<?php $_tmp8=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['PICKLIST_FIELD_ID'] = new Smarty_variable($_tmp8, null, 0);?>
													<?php }else{ ?> 
														<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getId();?>
<?php $_tmp9=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['PICKLIST_FIELD_ID'] = new Smarty_variable($_tmp9, null, 0);?>
													<?php }?>
												<?php }else{ ?>
													<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getId();?>
<?php $_tmp10=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['PICKLIST_FIELD_ID'] = new Smarty_variable($_tmp10, null, 0);?>
												<?php }?>
											<?php }?>
											<span <?php if (!empty($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value)){?> class="picklist-color picklist-<?php echo $_smarty_tpl->tpl_vars['PICKLIST_FIELD_ID']->value;?>
-<?php echo Vtiger_Util_Helper::convertSpaceToHyphen($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_RAWVALUE']->value);?>
...
<?php $_tmp11=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['COLSPAN_WIDTH'] = new Smarty_variable($_tmp11+1, null, 0);?>
