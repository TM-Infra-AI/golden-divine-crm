<?php /* Smarty version Smarty-3.1.7, created on 2021-06-26 08:56:32
         compiled from "/home/marketingmindz/goldendivinecrm.marketingmindz.com/includes/runtime/../../layouts/v7/modules/Documents/DocumentsRelatedList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:64432693160d6ebc003fdf5-67941845%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '280b7e52c5a677d710681ea3a6de4c5035bfe681' => 
    array (
      0 => '/home/marketingmindz/goldendivinecrm.marketingmindz.com/includes/runtime/../../layouts/v7/modules/Documents/DocumentsRelatedList.tpl',
      1 => 1584082245,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '64432693160d6ebc003fdf5-67941845',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60d6ebc0105e2',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60d6ebc0105e2')) {function content_60d6ebc0105e2($_smarty_tpl) {?>
...
"><i title="<?php echo vtranslate('LBL_VIEW_FILE',$_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value);?>
...
;return {field: {get: function(name, property) {if(name && property === undefined) {return fieldInfo[name];}if(name && property) {return fieldInfo[name][property]}},isMandatory : function(name){if(fieldInfo[name]) {return fieldInfo[name].mandatory;}return false;},getType : function(name){if(fieldInfo[name]) {return fieldInfo[name].type}return false;}},};})();</script></div><!-- image popup --><div id="ImagePOP" class="modal fade" role="dialog" data-backdrop="static" style="display: none;"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h3 class="imgName"></h3><button type="button" class="close" data-dismiss="modal">&times;</button></div><div class="modal-body"><img class="customImageBox" src=""></div><div class="modal-footer"><button type="button" class="btn btn-danger" style="float: left;" id="cancelgiftcard" data-dismiss="modal"><strong><?php echo vtranslate('LBL_CANCEL','Vtiger');?>
