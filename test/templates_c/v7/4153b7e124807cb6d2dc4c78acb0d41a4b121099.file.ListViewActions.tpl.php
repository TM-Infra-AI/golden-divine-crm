<?php /* Smarty version Smarty-3.1.7, created on 2021-06-26 06:15:50
         compiled from "/home/marketingmindz/goldendivinecrm.marketingmindz.com/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:46577533260cb4d9d2d9a92-04991103%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4153b7e124807cb6d2dc4c78acb0d41a4b121099' => 
    array (
      0 => '/home/marketingmindz/goldendivinecrm.marketingmindz.com/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewActions.tpl',
      1 => 1624688067,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '46577533260cb4d9d2d9a92-04991103',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_60cb4d9d38a59',
  'variables' => 
  array (
    'MODULE_NAME' => 0,
...
<?php if ($_valid && !is_callable('content_60cb4d9d38a59')) {function content_60cb4d9d38a59($_smarty_tpl) {?>

<?php $_smarty_tpl->tpl_vars['LISTVIEW_MASSACTIONS_1'] = new Smarty_variable(array(), null, 0);?><div id="listview-actions" class="listview-actions-container"><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value!='SalesOrder'){?><?php  $_smarty_tpl->tpl_vars['LIST_MASSACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LIST_MASSACTION']->_loop = false;
...
" disabled="disabled"><i class="fa fa-pencil"></i></button><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='SalesOrder'){?><?php if ($_smarty_tpl->tpl_vars['deleteAction']->value){?><button type="button" class="btn btn-default" id=<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
" disabled="disabled"><i class="fa fa-trash"></i></button><?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['commentAction']->value){?><button type="button" class="btn btn-default" id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
