<?php /* Smarty version Smarty-3.1.7, created on 2021-06-17 13:40:55
         compiled from "/home/marketingmindz/goldendivinecrm.marketingmindz.com/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:156858254860cb50e7d93ac8-02774471%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f6e819791d6eae2db0e61f00961dedf3aced7185' => 
    array (
      0 => '/home/marketingmindz/goldendivinecrm.marketingmindz.com/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsEdit.tpl',
      1 => 1583395309,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '156858254860cb50e7d93ac8-02774471',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60cb50e7e6e8c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60cb50e7e6e8c')) {function content_60cb50e7e6e8c($_smarty_tpl) {?>
...
" /><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['SELECTED_CURRENCY']->value['currency_id'];?>
" id="selectedCurrencyId" /></center></div><div class="col-lg-4 col-md-4 col-sm-4" style="top: 3px;" id="tax-mode"><div style="float: right;"><i class="fa fa-info-circle"></i>&nbsp;<label><?php echo vtranslate('LBL_TAX_MODE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?></span></td></tr><?php }?><tr id="pre-tax"><td width="83%"><span class="pull-right"><strong><?php echo vtranslate('LBL_PRE_TAX_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?></span></td></tr><!-- Group Tax - ends --><?php if ($_smarty_tpl->tpl_vars['SH_PERCENT_EDITABLE']->value){?><tr id="tax-on-charges"><td width="83%"><span class="pull-right">(+)&nbsp;<strong><a href="javascript:void(0)" id="chargeTaxes"><?php echo vtranslate('LBL_TAXES_ON_CHARGES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?></span></td></tr><tr id="deducted-tax"><td width="83%"><span class="pull-right">(-)&nbsp;<strong><a href="javascript:void(0)" id="deductTaxes"><?php echo vtranslate('LBL_DEDUCTED_TAXES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?></span></td></tr><?php }?><tr valign="top" class="adjustment"><td width="83%" ><div class="pull-right"><strong><?php echo vtranslate('LBL_ADJUSTMENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
