<?php /* Smarty version Smarty-3.1.7, created on 2021-06-26 06:22:27
         compiled from "/home/marketingmindz/goldendivinecrm.marketingmindz.com/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:208302867660cb4da510af51-77272280%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2c38d4a2e14c7a56404bc2155786ead2897a4b10' => 
    array (
      0 => '/home/marketingmindz/goldendivinecrm.marketingmindz.com/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewBlockView.tpl',
      1 => 1624688317,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '208302867660cb4da510af51-77272280',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_60cb4da5189c9',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_60cb4da5189c9')) {function content_60cb4da5189c9($_smarty_tpl) {?>
...
' /><?php }?><!-- <pre><?php echo print_r($_smarty_tpl->tpl_vars['ROLE']->value);?>
...
?><!-- <pre><?php echo print_r($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'));?>
...
" data-displayvalue='<?php echo $_smarty_tpl->tpl_vars['FIELD_DISPLAY_VALUE']->value;?>
' data-value="<?php echo $_smarty_tpl->tpl_vars['FIELD_VALUE']->value;?>
" /><?php }?></span><!-- ($MODULE_NAME eq 'Accounts' && $ROLE eq 'H4'  && $FIELD_MODEL->get('label') eq 'Account Name') --><?php if (($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='SalesOrder'&&$_smarty_tpl->tpl_vars['ROLE']->value=='H4'&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label')=='Account Name'||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label')=='Subject')||($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='Accounts'&&$_smarty_tpl->tpl_vars['ROLE']->value=='H4'&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label')=='Account Name')){?><span class="action pull-right" style="display: none;"><a href="#" onclick="return false;" class="editAction fa fa-pencil"></a></span><?php }else{ ?><span class="action pull-right" ><a href="#" onclick="return false;" class="editAction fa fa-pencil"></a></span><?php }?><?php }?></td><?php }?><?php if (count($_smarty_tpl->tpl_vars['FIELD_MODEL_LIST']->value)==1&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="19"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="20"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="30"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')!="recurringtype"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="69"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="105"){?><td class="fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></td><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
