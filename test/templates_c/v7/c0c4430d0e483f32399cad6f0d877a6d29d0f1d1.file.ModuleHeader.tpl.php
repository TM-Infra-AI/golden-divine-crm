<?php /* Smarty version Smarty-3.1.7, created on 2021-02-18 12:18:00
         compiled from "/home/devmindz/public_html/Golden_divine/includes/runtime/../../layouts/v7/modules/Vtiger/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5822238875e60b5438d2f73-17288921%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c0c4430d0e483f32399cad6f0d877a6d29d0f1d1' => 
    array (
      0 => '/home/devmindz/public_html/Golden_divine/includes/runtime/../../layouts/v7/modules/Vtiger/ModuleHeader.tpl',
      1 => 1613650677,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5822238875e60b5438d2f73-17288921',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5e60b5439ed3c',
  'variables' => 
  array (
    'MODULE' => 0,
    'MODULE_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_5e60b5439ed3c')) {function content_5e60b5439ed3c($_smarty_tpl) {?>
...
">&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
 &nbsp;&nbsp;</a></p><?php }?></div><div class="col-lg-5 col-md-5 pull-right"><div id="appnav" class="navbar-right"><ul class="nav navbar-nav"><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='SalesOrder'){?><?php $_smarty_tpl->tpl_vars['ROLEID'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('roleid'), null, 0);?><li><button class="btn btn-default module-buttons" type="button" onclick="window.location.href = &quot;index.php?module=Products&amp;view=Edit&amp;app=INVENTORY&quot;"><div class="fa fa-plus" aria-hidden="true"></div> &nbsp;&nbsp;Add Product</button></li><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value!='SalesOrder'){?><?php  $_smarty_tpl->tpl_vars['BASIC_ACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BASIC_ACTION']->_loop = false;
...
</a></li><?php } ?></ul></div></li><?php }?></ul><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('roleid')=='H4'||$_smarty_tpl->tpl_vars['USER_MODEL']->value->get('roleid')=='H2'||$_smarty_tpl->tpl_vars['USER_MODEL']->value->get('roleid')=='H5'){?><ul class="nav navbar-nav"><?php  $_smarty_tpl->tpl_vars['BASIC_ACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BASIC_ACTION']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['MODULE_BASIC_ACTIONS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['BASIC_ACTION']->key => $_smarty_tpl->tpl_vars['BASIC_ACTION']->value){
$_smarty_tpl->tpl_vars['BASIC_ACTION']->_loop = true;
?><?php if ($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel()=='LBL_IMPORT'){?><li><button id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
"><a href=<?php echo $_smarty_tpl->tpl_vars['SETTING']->value->getUrl();?>
><?php echo vtranslate($_smarty_tpl->tpl_vars['SETTING']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value,vtranslate($_smarty_tpl->tpl_vars['MODULE_NAME']->value,$_smarty_tpl->tpl_vars['MODULE_NAME']->value));?>
</a></li><?php } ?></ul></div></li><?php }?></ul><?php }?><?php }?></div></div></div><?php if ($_smarty_tpl->tpl_vars['FIELDS_INFO']->value!=null){?><script type="text/javascript">var uimeta = (function () {var fieldInfo = <?php echo $_smarty_tpl->tpl_vars['FIELDS_INFO']->value;?>
