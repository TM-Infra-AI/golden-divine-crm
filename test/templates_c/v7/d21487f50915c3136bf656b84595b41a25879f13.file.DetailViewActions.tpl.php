<?php /* Smarty version Smarty-3.1.7, created on 2021-07-13 11:29:05
         compiled from "/home/marketingmindz/goldendivinecrm.marketingmindz.com/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:169577437560cb4da4f245e2-09144958%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd21487f50915c3136bf656b84595b41a25879f13' => 
    array (
      0 => '/home/marketingmindz/goldendivinecrm.marketingmindz.com/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewActions.tpl',
      1 => 1626175735,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '169577437560cb4da4f245e2-09144958',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_60cb4da50197c',
  'variables' => 
  array (
    'RECORD' => 0,
    'MODULE_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_60cb4da50197c')) {function content_60cb4da50197c($_smarty_tpl) {?>
    <div class="col-lg-6 detailViewButtoncontainer"><div class="pull-right btn-toolbar"><div class="btn-group"><?php $_smarty_tpl->tpl_vars['STARRED'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD']->value->get('starred'), null, 0);?><?php if ($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->isStarredEnabled()){?><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='SalesOrder'){?><?php $_smarty_tpl->tpl_vars['ROLEID'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('roleid'), null, 0);?><button class="btn btn-default" onclick="window.location = 'index.php?module=SalesOrder&action=SalesorderBill&record=<?php echo $_GET['record'];?>
'"><?php echo vtranslate('Export to pdf',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><?php }?><button class="btn btn-default markStar <?php if ($_smarty_tpl->tpl_vars['STARRED']->value){?> active <?php }?>" id="starToggle" style="width:100px;"><div class='starredStatus' title="<?php echo vtranslate('LBL_STARRED',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
?><?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->getLabel()=='LBL_EDIT'){?><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='SalesOrder'){?><?php $_smarty_tpl->tpl_vars['ROLEID'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('roleid'), null, 0);?><?php if ($_smarty_tpl->tpl_vars['ROLEID']->value=='H2'||$_smarty_tpl->tpl_vars['ROLEID']->value=='H4'||$_smarty_tpl->tpl_vars['ROLEID']->value=='H5'){?><button class="btn btn-default" id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
...
</button><?php }?><?php }else{ ?><button class="btn btn-default" id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
_detailView_basicAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->getLabel());?>
"<?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->isPageLoadLink()){?>onclick="window.location.href = '<?php echo $_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->getUrl();?>
&app=<?php echo $_smarty_tpl->tpl_vars['SELECTED_MENU_CATEGORY']->value;?>
'"<?php }else{ ?>onclick="<?php echo $_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->getUrl();?>
...
" data-filename="<?php echo $_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->get('filename');?>
"<?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</button><?php }?><?php }?><?php } ?><?php if (count($_smarty_tpl->tpl_vars['DETAILVIEW_LINKS']->value['DETAILVIEW'])>0){?><?php if ($_smarty_tpl->tpl_vars['USER_MODEL']->value->isAdminUser()==1){?><button class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);"><?php echo vtranslate('LBL_MORE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
&nbsp;&nbsp;<i class="caret"></i></button><?php }?><ul class="dropdown-menu dropdown-menu-right"><?php  $_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->_loop = false;
...
?><?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel()==''){?><li class="divider"></li><?php }else{ ?><?php $_smarty_tpl->tpl_vars['delete_sales_order'] = new Smarty_variable(vtranslate($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value), null, 0);?><?php if ($_smarty_tpl->tpl_vars['delete_sales_order']->value!="Delete Sales Estimate"){?><li id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
...
&app=<?php echo $_smarty_tpl->tpl_vars['SELECTED_MENU_CATEGORY']->value;?>
' ><?php echo vtranslate($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a><?php }?></li><?php }?><?php }?><?php } ?></ul><?php }?></div><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['NO_PAGINATION']->value;?>
